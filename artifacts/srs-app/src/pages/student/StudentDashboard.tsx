...
function ShadowCard({
  ...
  return (
    <div
      className={`bg-white rounded-3xl border border-slate-200 shadow-[0_4px_24px_-4px_rgba(15,23,42,0.12)] ${hover ? "hover:shadow-[0_8px_32px_-4px_rgba(15,23,42,0.18)] hover:-translate-y-0.5" : ""} transition-all duration-200 ${className}`}
    >
      {children}
    </div>
  );
      ...
      <div className="space-y-6 font-['Inter']">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <Link href="/student/achievements">
            <div
              className="col-span-5 rounded-3xl border border-violet-100 shadow-[0_4px_24px_-4px_rgba(139,92,246,0.18)] hover:shadow-[0_8px_32px_-4px_rgba(139,92,246,0.28)] hover:-translate-y-0.5 transition-all duration-200 p-6 relative overflow-hidden cursor-pointer"
              style={{
